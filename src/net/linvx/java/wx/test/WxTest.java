...
public class WxTest {
	...
	public static String test9(HttpServletRequest r) {
		org.apache.commons.configuration.XMLConfiguration config = MyConfigReader.getConfig("dbconfig");
		System.out.println(config);
		List<HierarchicalConfiguration> fields = config.configurationsAt("db");
